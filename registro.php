                           ...
                           <li><i class="fas fa-check"></i>Todos los talleres</li>
                                ...
                                <div class="orden">
                                 ...
                                 <input type="number" min="0" id="pase_completo" size="3" name="boletos[]" placeholder="0">
                                      ...
                                      <li>
                                          <div class="tabla-precio">
                          <h3>Pase por 2 día (Vienres y Sábados)</h3>
                          <p class="numero">$45</p>
                          <ul>
                            <li><i class="fas fa-check"></i>Bocadillos Gratis</li>
                            <li><i class="fas fa-check"></i>Todas las conferencias</li>
  ...
  <div class="caja clearfix">
    <div class="extras">
      <div class="orden">
        ...
        <input type="number" min="0" id="camisa_evento" size="8" placeholder="0">
      </div><!--.orden-->
      <div class="orden">
        <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML5, CSS3, JavaScript, Chrome.)</small></label>
        <input type="number" min="0" id="etiquetas" name="pedido_etiquetas" size="8" placeholder="0">
      </div><!--.orden-->
      <div class="orden">
    ...
    <div class="total">
            ...
            <input type="submit" id="botonregistro" name="submit" class="boton" value="Pagar">
    </div><!--total-->
</div><!--caja-->
</div><!--resumen-->
  </form>
